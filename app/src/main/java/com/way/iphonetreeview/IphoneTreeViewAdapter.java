...
public class IphoneTreeViewAdapter extends BaseExpandableListAdapter
	...
	public IphoneTreeViewAdapter(Activity activity,IphoneTreeView iphoneTreeView) {
	...
	public IphoneTreeViewAdapter(Activity activity,IphoneTreeView2 iphoneTreeView) {
		// TODO Auto-generated constructor stub
		mInflater= (LayoutInflater) activity.getLayoutInflater();
//		this. iphoneTreeView=iphoneTreeView;
		groupStatusMap = new HashMap<Integer, Integer>();
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		if (isExpanded) {
			indicator.setImageResource(R.drawable.iphonetreeview_indicator_expanded);
		} else {
			indicator.setImageResource(R.drawable.iphonetreeview_indicator_unexpanded);
		}
		return convertView;
	}
